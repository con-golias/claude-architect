...
export function generateEntity(name: string, description: string): string {
  return `/**
...
export function generateRepositoryPort(name: string): string {
  return `/**
...
export function generateUseCase(name: string): string {
  return `/**
...
export function generateMapper(name: string): string {
  return `/**
...
export function generateRepositoryImpl(name: string): string {
  return `/**
